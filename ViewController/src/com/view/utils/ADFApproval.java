...
System.out.println("22222222222");
    ...
    //on submit of LR dynamic
    public static String invokeLRSubmitPkg(String ref_id,String submitPkg) throws SQLException {
        ...
        System.err.println("submitPkg==>" + submitPkg + "p_ref_id==>" + p_ref_id );        
              dobProcArgs =
                new Object[][] { { "IN", p_ref_id, OracleTypes.NUMBER }, //0
...
System.out.println("66666666666666");
    ...
    //update LR extra and total leave days on save
    public static String updateLrProc(String procName,String lrId) throws SQLException {
        ...
        dobProcArgs =
                new Object[][] { 
                    { "IN", p_lrId, OracleTypes.VARCHAR }, //0
                    { "OUT", p_err_code, OracleTypes.VARCHAR }, //1
                    } ;
        try {
            ApplicationModuleImpl am =(ApplicationModuleImpl)ADFUtils.getApplicationModuleForDataControl(null);
